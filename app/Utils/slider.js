...
var VanillaSlider =
  ...
  function VanillaSlider(containerId) {
    ...
    this.autoPauseOnHover =
      typeof this.autoPauseOnHover === "boolean" ? this.autoPauseOnHover : true
    ...
    if (this.webp) {
      ...
      var ieSupport =
        parseInt(ua.substring(edge + 5, ua.indexOf(".", edge)), 10) > 17
      var webpTest
    ...
    this.setSlideText = function (index) {
      ...
      if (_this.images[index].textTitle || _this.images[index].textBody) {
        ...
        _this.images[index].textPosition =
          typeof _this.images[index].textPosition === "string"
            ? _this.images[index].textPosition
            : "SW"
    ...
    this.revealSlideText = function (index) {
      if (
        (_this.images[index].textTitle || _this.images[index].textBody) &&
        _this.textOverlay
      ) {
